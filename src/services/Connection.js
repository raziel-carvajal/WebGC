...
function Connection (receiver, initiator, usingSigSer, profile) {
  if (!(this instanceof Connection)) return new Connection(receiver, initiator, usingSigSer, profile)
  EventEmitter.call(this)
  this._receiver = receiver
  this._initiator = initiator
  this._usingSigSer = usingSigSer
  this._rcvProfile = profile
  this._isOpen = false
  this._msgsQueue = []
  this._peer = new Peer({
    'initiator': initiator,
