(function(exports){
  ...
  * @param {Integer} value - Preference of the local peer.*/
  ...
  /**
  * This method computes the absolute value of the diference among {@link a} and {@link b}.
  * @method _eval
  ...
  * @returns {Integer} Absolute value of (a - b).*/
  ...
  /**
  * This method gets a subset with the {@link n} most similar items to the local peer from
  * the dictionary {@link dict}.
  ...
  * @returns {Dictionary} Subset of {@link dict}.*/
