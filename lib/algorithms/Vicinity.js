...
(function(exports){
  ...
  * @author Raziel Carvajal <raziel.carvajal-gomez@inria.fr> */
  function Vicinity(opts){
    ...
    this.gossipUtil.setOutput(opts.peerId, this.constructor.name);
    this.gossipUtil.extendProperties(opts.peerJsOpts, {logFunction: this.log});
    GossipProtocol.call(this, opts.peerId, opts.peerJsOpts);
    this.selectionPolicy = opts.selectionPolicy;
    this.proximityFunc = this.instantiateSimFunc(opts.similarityFunction);
  ...
  * @default */
  ...
  // the variable util, it is defined by PeerJS and normally it is loaded when PeerJS
  // it is specified in a web page.
